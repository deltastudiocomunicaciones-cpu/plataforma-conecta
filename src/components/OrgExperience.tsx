...
const nivelarPilotMembers: NivelarPilotMember[] = [
  ...
  {
    id: "unidad-pymes-06",
    name: "Estiven Sanchez",
    role: "Asistente Pymes",
    emailHint: "estiven",
    connection: "6h 58m",
    productive: "73%",
    unproductive: "8%",
    unclassified: "19%",
    status: "pendiente",
    signal: "Asistente Pymes preparado para lectura de apoyo operativo.",
    workWindow: "08:12 a 17:02",
    interpretation: "El rol de asistencia debe leerse por soporte a entregables, carga documental y respuesta a requerimientos internos.",
    conectaReading: "Conecta cruzará su actividad con tareas apoyadas, evidencias cargadas y solicitudes de Gerencia Pymes.",
    recommendedAction: "Vincular cédula/correo y definir qué tareas de apoyo alimentarán el informe semanal.",
  },
  {
    id: "unidad-pymes-07",
    name: "Diana Bernal",
    ...
    unclassified: "18%",
    status: "pendiente",
    signal: "Asistente Pymes preparada para lectura de apoyo operativo.",
    workWindow: "08:05 a 17:14",
    interpretation: "La medición debe distinguir apoyo operativo real, seguimiento documental y tareas administrativas asociadas a clientes Pymes.",
    conectaReading: "Conecta permitirá ver si la actividad de apoyo se refleja en pendientes cerrados, soportes y alertas oportunas.",
    recommendedAction: "Vincular cédula/correo y asociar sus tareas al flujo de soporte de Gerencia Pymes.",
  },
];
